...
class ComplexDifferentEffectsModelFixedR(BaseCMModel):
    """
    Complex Different Effects Model
    ...
    def build_model(self, R_prior_mean=3.28, cm_prior_scale=10, cm_prior='skewed',
        ...
        with self.model:
            ...
            self.RegionR = np.array([3.41252836, 2.9450382, 3.36868476, 3.58791396, 3.29521114,
                                     3.51017831, 3.44189814, 3.50295631, 2.61716436, 2.92682899,
                                     2.80280836, 3.37071802, 3.46440532, 3.13622231, 3.16885926,
                                     3.79197608, 1.94359329, 3.73419494, 3.79796035, 3.28920025,
                                     3.07602915, 3.24258333, 2.95736943, 3.28120416, 3.66474214,
                                     3.47508088, 3.29326163, 2.75753838, 2.83798879, 3.85743108,
                                     3.6298973, 3.86402372, 3.62632221, 2.77473417, 3.44640995,
                                     3.08749182, 3.81205554, 3.54374207, 2.34789242, 3.15609154,
                                     2.96393016])
